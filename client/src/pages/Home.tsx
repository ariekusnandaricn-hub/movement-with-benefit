                  ...
                  {judge ? (
                    <>
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-3xl md:text-4xl font-mono font-bold text-white">{judge.name}</p>
                        <p className="text-lg md:text-xl font-mono font-semibold text-cyan-300">JURI UTAMA KATEGORI {category.toUpperCase()}</p>
                        {judge.description && <p className="text-sm md:text-base leading-relaxed text-slate-300">{judge.description}</p>}
                      </div>
                    </>
                  ) : null}
                </div>
